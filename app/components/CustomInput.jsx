...
const CustomInput = ({ label, placeholder, textarea, deleteIcon, value, setValue, handleDelete }) => {
  return (
      ...
      <label className="flex flex-1 flex-col gap-2">
        ...
        {textarea ? (
          ...
          <input
            ...
            value={value}
            onChange={setValue}
            className="py-2 px-3 border-[1px] rounded-lg border-neutral-600 bg-darkGray outline-none focus:outline-none hover:cursor-pointer placeholder:text-mediumGray placeholder:text-[15px]"
            placeholder={placeholder}
          />
        )}
      </label>
